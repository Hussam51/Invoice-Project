        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6" id="fnWrapper">
                            <label> {{__('users.User_name')}}: <span class="tx-danger">*</span></label>
                ...
                <div class="row mg-b-20">
                    ...
                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                        <label>  {{__('passwords.throttled')}}: <span class="tx-danger">*</span></label>
                ...
                <div class="row row-sm mg-b-20">
                    <div class="col-lg-6">
                        <label class="form-label"> {{__('users.Statue')}}</label>
                        <select name="Status" id="select-beast" class="form-control  nice-select  custom-select">
                            <option value="{{ $user->Status}}">{{ $user->Status}}</option>
                            <option value="مفعل">{{__('users.Enabled')}}</option>
                            <option value="غير مفعل"> {{__('users.Disabled')}}</option>
                        </select>
                    </div>
                </div>
